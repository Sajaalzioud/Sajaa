# Biography — Saja Ali Zioud

> **Status: DRAFT.** Everything marked `[TO CONFIRM]` must be verified by Saja before any
> version is published. Nothing here may be embellished — these drafts deliberately use
> only the confirmed facts (name, profession, clinic, country) plus clearly marked slots.
...
with developmental, sensory, and motor challenges and coaching the adults around them —
parents, teachers, and caregivers — to carry therapy into daily life.

Saja holds `[TO CONFIRM degree, university]` and is licensed to practice in Qatar
`[TO CONFIRM license/registration body]`. Through her website, workshops, and social
channels, she provides clear, evidence-based education for families and schools across
Qatar and the GCC.

## Long bio (~250 words) — for the About page, media kit

`[BUILD after Saja provides: education, license, certifications, years and settings of
practice, specialty training, languages spoken, professional memberships, any real
presentations/workshops already delivered. Structure to use:]`

1. Who she is and where she practices (confirmed facts)
2. Who she helps and how (caseload, approach, settings)
3. Training and credentials (verified only)
4. Her educational mission (website, workshops, resources)
5. Personal line (languages, why she chose OT) — humanizes the brand
6. Canonical identity block + contact/booking link
...
- [ ] Degree(s), university, graduation year
- [ ] Qatar license/registration details (what may be stated publicly)
- [ ] Certifications and specialty training (exact official names)
- [ ] Years of practice and settings (clinic, school, hospital, home-based)
- [ ] Primary caseload (ages, conditions) and preferred specialty framing
- [ ] Languages spoken
